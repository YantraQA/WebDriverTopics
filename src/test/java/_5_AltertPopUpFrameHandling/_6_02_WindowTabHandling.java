...
public class _6_02_WindowTabHandling {
	...
	public void tabHandling_1_() throws InterruptedException
	{
		...
		WebElement clickButtonForTab = driver.findElement(By.id("windowButton"));
		...
		WebElement textInTheNextWindow = driver.findElement(By.id("sampleHeading"));
		System.out.println("After opening the tab the text available on the page is -> " + textInTheNextWindow.getText());
		driver.close();
